...
public class PageDepthSummary extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder newBuilder() {
    return new org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder();
  }
  
  /** Creates a new PageDepthSummary RecordBuilder by copying an existing Builder */
  public static org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder newBuilder(org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder other) {
    return new org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder(other);
  }
  
  /** Creates a new PageDepthSummary RecordBuilder by copying an existing PageDepthSummary instance */
  public static org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder newBuilder(org.wikipedia.miner.extract.model.struct.PageDepthSummary other) {
    return new org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PageDepthSummary>
    ...
    private Builder() {
      super(org.wikipedia.miner.extract.model.struct.PageDepthSummary.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder other) {
      super(other);
    ...
    private Builder(org.wikipedia.miner.extract.model.struct.PageDepthSummary other) {
            super(org.wikipedia.miner.extract.model.struct.PageDepthSummary.SCHEMA$);
      if (isValidValue(fields()[0], other.depth)) {
        this.depth = data().deepCopy(fields()[0].schema(), other.depth);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'depthForwarded' field */
    public org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder setDepthForwarded(boolean value) {
    ...
    public org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder clearDepthForwarded() {
    ...
    public org.wikipedia.miner.extract.model.struct.PageDepthSummary.Builder clearChildIds() {
      childIds = null;
