...
public class PageKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.wikipedia.miner.extract.model.struct.PageKey.Builder newBuilder() {
    return new org.wikipedia.miner.extract.model.struct.PageKey.Builder();
  }
  
  /** Creates a new PageKey RecordBuilder by copying an existing Builder */
  public static org.wikipedia.miner.extract.model.struct.PageKey.Builder newBuilder(org.wikipedia.miner.extract.model.struct.PageKey.Builder other) {
    return new org.wikipedia.miner.extract.model.struct.PageKey.Builder(other);
  }
  
  /** Creates a new PageKey RecordBuilder by copying an existing PageKey instance */
  public static org.wikipedia.miner.extract.model.struct.PageKey.Builder newBuilder(org.wikipedia.miner.extract.model.struct.PageKey other) {
    return new org.wikipedia.miner.extract.model.struct.PageKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PageKey>
    ...
    private Builder() {
      super(org.wikipedia.miner.extract.model.struct.PageKey.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.wikipedia.miner.extract.model.struct.PageKey.Builder other) {
      super(other);
    ...
    private Builder(org.wikipedia.miner.extract.model.struct.PageKey other) {
            super(org.wikipedia.miner.extract.model.struct.PageKey.SCHEMA$);
      if (isValidValue(fields()[0], other.namespace)) {
        this.namespace = data().deepCopy(fields()[0].schema(), other.namespace);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'title' field */
    public org.wikipedia.miner.extract.model.struct.PageKey.Builder setTitle(java.lang.CharSequence value) {
    ...
    public org.wikipedia.miner.extract.model.struct.PageKey.Builder clearTitle() {
      title = null;
