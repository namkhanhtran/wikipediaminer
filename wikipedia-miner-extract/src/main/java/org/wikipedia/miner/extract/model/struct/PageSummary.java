...
public class PageSummary extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.wikipedia.miner.extract.model.struct.PageSummary.Builder newBuilder(org.wikipedia.miner.extract.model.struct.PageSummary.Builder other) {
    return new org.wikipedia.miner.extract.model.struct.PageSummary.Builder(other);
  }
  
  /** Creates a new PageSummary RecordBuilder by copying an existing PageSummary instance */
  public static org.wikipedia.miner.extract.model.struct.PageSummary.Builder newBuilder(org.wikipedia.miner.extract.model.struct.PageSummary other) {
    return new org.wikipedia.miner.extract.model.struct.PageSummary.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PageSummary>
    ...
    private Builder() {
      super(org.wikipedia.miner.extract.model.struct.PageSummary.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.wikipedia.miner.extract.model.struct.PageSummary.Builder other) {
      super(other);
    ...
    private Builder(org.wikipedia.miner.extract.model.struct.PageSummary other) {
            super(org.wikipedia.miner.extract.model.struct.PageSummary.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder setId(int value) {
    ...
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder clearId() {
    ...
    /** Sets the value of the 'title' field */
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder setTitle(java.lang.CharSequence value) {
    ...
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder clearTitle() {
      title = null;
    ...
    /** Sets the value of the 'namespace' field */
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder setNamespace(int value) {
    ...
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder clearNamespace() {
    ...
    public org.wikipedia.miner.extract.model.struct.PageSummary.Builder clearForwarded() {
